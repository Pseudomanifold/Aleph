'''
Permits installing Aleph Python bindings using an out-of-source build
that is triggered manually. Please note that this way of building the
bindings is currently *not* supported.
'''
