...
template <class T> void testDualization()
{
  ...
  auto pairing2 = aleph::calculatePersistencePairing<aleph::persistentHomology::algorithms::Standard>( boundaryMatrix,           true , IndexType(s) );
  ...
  auto pairing4 = aleph::calculatePersistencePairing<aleph::persistentHomology::algorithms::Twist>   ( boundaryMatrix          , true , IndexType(s) );
...
template <class T> void testPinchedTorus()
{
  ...
  auto D2 = aleph::calculateIntersectionHomology( L, {X0,X1,X2}, aleph::PerversityGM( {0} ), true );
...
template <class T> void testSphere()
{
  ...
  auto D3 = aleph::calculateIntersectionHomology( L, {X0,X0,K}, aleph::PerversityGM( {0} ), true );
...
template <class T> void testTorus()
{
  ...
  auto D2 = aleph::calculateIntersectionHomology( L, {X0,X1,X2,X3}, aleph::PerversityGM( {0,0} ), true );
  auto D3 = aleph::calculateIntersectionHomology( L, {X0,X1,X2,X3}, aleph::PerversityGM( {0,1} ), true );
