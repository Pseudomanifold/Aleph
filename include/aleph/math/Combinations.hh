#ifndef ALEPH_MATH_COMBINATIONS_HH__
#define ALEPH_MATH_COMBINATIONS_HH__

/**
  @file   Combinations.hh
  @brief  Algorithms for generating and iterating over combinations
  @author Howard Hinnant
  @author Bastian Rieck

  This is a slightly adjusted version of a set of combinatorial
  algorithms, originally provided by the kind *Howard Hinnant*,
  who describes the usage on his personal website.

  @see https://howardhinnant.github.io/combinations/combinations.html

  This version comes with additional namespaces to fit into the
  naming scheme of Aleph.
