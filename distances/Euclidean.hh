...
/**
  ...
  the \c accum_dist is specifically meant to be used with \c FLANN.
...
public:
  ...
  */
                         ...
                         ElementType worstDistance = -1.0 ) const
  {
    ...
    while( a < lastGroup )
    {
      diff0 = std::abs( ResultType( a[0] - b[0] ) );
      diff1 = std::abs( ResultType( a[1] - b[1] ) );
      diff2 = std::abs( ResultType( a[2] - b[2] ) );
      diff3 = std::abs( ResultType( a[3] - b[3] ) );
